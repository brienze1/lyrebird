...
type UpstreamDTO struct {
	...
	MatchPath     string `json:"match_path,omitempty" yaml:"match_path,omitempty"`
...
func UpstreamToDTO(u domain.Upstream) UpstreamDTO {
	return UpstreamDTO{MatchHost: u.MatchHost, MatchPath: u.MatchPath, TargetURL: u.TargetURL, TLSSkipVerify: u.TLSSkipVerify}
}
...
func NewUpstreamDTOFromFields(matchHost, matchPath, targetURL string, tlsSkipVerify bool) UpstreamDTO {
	return UpstreamDTO{MatchHost: matchHost, MatchPath: matchPath, TargetURL: targetURL, TLSSkipVerify: tlsSkipVerify}
}
...
func UpstreamFromDTO(partition string, d UpstreamDTO) domain.Upstream {
	return domain.Upstream{Partition: partition, MatchHost: d.MatchHost, MatchPath: d.MatchPath, TargetURL: d.TargetURL, TLSSkipVerify: d.TLSSkipVerify}
}
